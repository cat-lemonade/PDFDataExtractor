...
from pdfminer.layout import LAParams, LTTextLine, LTTextBox, LTChar, LTAnno
...
class Reader:
    ...
    def __init__(self, showPublisher=None):
        ...
        """
        self.publishers = ['elsevier', 'rsc.', 'acs', 'chem. eur. j', 'wiley-vch gmbh', 'angewandte', 'springer']
    ...
    def single_page_layout(self, layout, page_seq, page_x, page_y):
        ...
        :param dic_page: A dictionary that stores the results, keys are page number and textblock number; Values are
                         features generated at this step
        """
        ...
        for lt_obj_seq, lt_obj in enumerate(layout):
            if isinstance(lt_obj, LTTextBox) or isinstance(lt_obj, LTTextLine):
                ...
                dic_page[int(page_seq), int(lt_obj_seq)] = {  # i -> page_number, j-> obj_number on each page
                    ...
                    'universal_sequence': self.universal_sequence,
                    # Universal sequence number across the whole PDF dcocument
                    ...
                    # Number of words in the text block
    ...
    def extraction(self, publisher_name, pdf):
        ...
        elif publisher_name == 'wiley-vch gmbh':
    ...
    def read_file(self, file_name):
        ...
        try:
            ...
            pdf_extracted = self.extraction(self.publishers, pdf)
